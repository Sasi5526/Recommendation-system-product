# -*- coding: utf-8 -*-
"""
Created on Fri Jul  9 10:55:54 2021
...
sales_df = pd.read_csv('C:\\Users\\sasim\\OneDrive\\Desktop\\Product-Recommendation-System\\Sales-Transactions-Edited.csv')
...
cust_prod_rankings_df.to_csv('C:\\Users\\sasim\\OneDrive\\Desktop\\Product-Recommendation-System\\Customer-Product-Rankings.csv',index=False)


pickle.dump(cust_prod_rankings_df, open('cust_prod_ranking_model1.pkl','wb'))
